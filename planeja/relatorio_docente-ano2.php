...
class PDF extends FPDF
{
  ...
  function Header()
  {
    ...
    $this->SetXY(17, 50);
    $this->Cell(170, 15, "DOCENTE: " . $docente . " - ANO: " . $ano, 0, 0, 'C');
...
$ano1 = $ano . '1';
$ano2 = $ano . '2';
$sql = $connect->query("SELECT * FROM planejamento WHERE docente = '$docente' AND (anosemestre = '$ano1' OR anosemestre = '$ano2') ORDER BY anosemestre ASC, data_ini ASC ");
