...
function fillItem() {
    ...
    let url = `/api/laboratory/permanents/${current_index}/`;
    $.get(url, (response) => {
...
function getMaterials(url = undefined) {
    ...
    if (!url) {
        ...
        url = `/api/laboratory/permanents/?${filters}`;
    }
...
$(document).ready(function () {
    ...
    $("#delete-material").click(function (e) {
        e.preventDefault();
        $.ajax({
            url: `/api/laboratory/permanents/${current_index}/`,
            type: "DELETE",
            success: function (response) {
    ...
    $("#del-category").click(function (e) {
        ...
        $("#form-errors").html("");
        $.ajax({
            url: `/api/laboratory/categories/${$("#category").val()}/`,
            type: "DELETE",
            success: function (response) {
                getCategories();
            },
