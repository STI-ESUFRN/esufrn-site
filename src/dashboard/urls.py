...
urlpatterns = [
    ...
    path("periodo/historico/", periodoHistorico,
    ...
    path("inventario/emprestimo", inventarioEmprestimo,
         name="inventario_emprestimo"),
    path("inventario/patrimonio", inventarioPatrimonio,
         name="inventario_patrimonio"),
