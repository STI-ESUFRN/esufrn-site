# Generated by Django 4.0.9 on 2023-11-13 23:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='chamado',
            name='concorda',
            field=models.CharField(choices=[('y', 'SIM')], default=True, max_length=1, verbose_name='Marcando esta caixa você declara que estará presente no momento da manutenção'),
