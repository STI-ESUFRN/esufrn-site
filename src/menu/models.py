...
class Itens(models.Model):
    ...
    action_type = models.CharField("Tipo", max_length=100, choices=TYPE_CHOICES, default="hover",
                                   help_text="Hover: Ao clicar ou passar o mouse sobre, abrirá os subitens; Link: Ao clicar abrirá o link inserido.")
    footer = models.BooleanField(
        "Rodapé", help_text="Mostrar menu e seus respectivos subitens no rodapé da página", default=False)
...
class SubItens(models.Model):
    ...
    menu = models.ForeignKey(Itens, on_delete=models.CASCADE, null=True)
    decoration = models.CharField(
        "Class estilo", blank=True, null=True, max_length=100, help_text="Classes CSS extra")
    ...
    def save(self, *args, **kwargs):
        ...
        super(SubItens, self).save(*args, **kwargs)
...
class SubSubItens(models.Model):
    name = models.CharField("Nome", max_length=100)
    link = models.CharField("Link", max_length=255)
    order = models.IntegerField("Ordem")
    submenu = models.ForeignKey(SubItens, on_delete=models.CASCADE, null=True)
    decoration = models.CharField(
        "Class estilo", blank=True, null=True, max_length=100, help_text="Classes CSS extra")
