...
urlpatterns = [
    ...
    path("ensino/sobre/", ensino_sobre,
         name="ensino_sobre"),
    path("ensino/tecnico/", ensino_tecnico,
         name="ensino_tecnico"),
    path("ensino/graduacao/", ensino_graduacao,
         name="ensino_graduacao"),
    path("ensino/especializacao/", ensino_especializacao,
         name="ensino_especializacao"),
    path("ensino/mestrado/", ensino_mestrado,
         name="ensino_mestrado"),
    path("ensino/pronatec/", ensino_pronatec,
